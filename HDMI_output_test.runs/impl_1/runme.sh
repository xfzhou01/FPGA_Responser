...
HD_PWD='C:/Users/84546/Desktop/main/HDMI_output_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Logic_Show_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Logic_Show_Top.tcl -notrace
