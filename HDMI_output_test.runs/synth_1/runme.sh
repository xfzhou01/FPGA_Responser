...
HD_PWD='C:/Users/84546/Desktop/main/HDMI_output_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Logic_Show_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Logic_Show_Top.tcl
