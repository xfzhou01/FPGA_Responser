...
HD_PWD='C:/Users/84546/Desktop/main/HDMI_output_test.runs/r1_dist_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log r1_dist_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source r1_dist_mem_gen_0_0.tcl
