...
HD_PWD='C:/Users/84546/Desktop/main/HDMI_output_test.runs/romset_ansa_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log romset_ansa_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source romset_ansa_0.tcl
