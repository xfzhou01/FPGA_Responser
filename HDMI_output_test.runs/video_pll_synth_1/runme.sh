...
HD_PWD='C:/Users/84546/Desktop/main/HDMI_output_test.runs/video_pll_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log video_pll.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source video_pll.tcl
